 ...
 *
 * Recall from the Objects task that Quiz Questions
 * can come in either Multiple Choice or Short Answer.
 *
 * You will need a single state to handle whether
 * the type is multiple_choice_question or short_answer_question.
 *
